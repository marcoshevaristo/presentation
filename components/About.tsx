            ...
            <div className="container mx-auto px-6">
                ...
                <div className="max-w-3xl mx-auto">
                    <div className="prose prose-lg dark:prose-invert mx-auto">
                        ...
                        <p className="text-zinc-600 dark:text-zinc-400 text-lg leading-relaxed mb-6">
                            My journey in software development started {new Date().getFullYear() - 2016} years ago, and since then I've worked on
                            various projects ranging from small business websites to large-scale enterprise applications.
                            I'm constantly learning and staying up-to-date with the latest industry trends.
                        </p>
                        <p className="text-zinc-600 dark:text-zinc-400 text-lg leading-relaxed">
                            I believe in continuous improvement and enjoy collaborating with talented individuals to bring ideas to life.
                        </p>
                    </div>
                </div>
            </div>
